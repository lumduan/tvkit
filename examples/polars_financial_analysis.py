...
def demonstrate_polars_financial_analysis():
    ...
    sample_data = [
        {"timestamp": 1672531200.0, "open": 16500.25, "high": 16650.75, "low": 16480.10, "close": 16620.50, "volume": 125000.0},
        {"timestamp": 1672531260.0, "open": 16620.50, "high": 16700.25, "low": 16600.00, "close": 16680.75, "volume": 135000.0},
        {"timestamp": 1672531320.0, "open": 16680.75, "high": 16720.50, "low": 16650.25, "close": 16705.30, "volume": 142000.0},
        {"timestamp": 1672531380.0, "open": 16705.30, "high": 16750.80, "low": 16695.10, "close": 16730.45, "volume": 138000.0},
        {"timestamp": 1672531440.0, "open": 16730.45, "high": 16780.25, "low": 16720.90, "close": 16765.60, "volume": 151000.0},
        {"timestamp": 1672531500.0, "open": 16765.60, "high": 16800.30, "low": 16750.15, "close": 16785.40, "volume": 146000.0},
        {"timestamp": 1672531560.0, "open": 16785.40, "high": 16820.75, "low": 16770.25, "close": 16810.90, "volume": 159000.0},
        {"timestamp": 1672531620.0, "open": 16810.90, "high": 16850.60, "low": 16800.45, "close": 16835.20, "volume": 163000.0},
        {"timestamp": 1672531680.0, "open": 16835.20, "high": 16870.40, "low": 16825.10, "close": 16855.75, "volume": 157000.0},
        {"timestamp": 1672531740.0, "open": 16855.75, "high": 16890.25, "low": 16840.60, "close": 16875.30, "volume": 169000.0},
    ]
    ...
    financial_df = df.with_columns([
        # Convert timestamp to datetime
        (pl.col("timestamp") * 1000).cast(pl.Datetime(time_unit="ms")).alias("datetime"),
        ...
        ((pl.col("high") + pl.col("low") + pl.col("close")) / 3 * pl.col("volume")).alias("vwap_numerator"),
    ]).with_columns([
        # Moving averages
    ...
    print(financial_df.select([
        "datetime", "close", "return_pct", "sma_3", "sma_5",
        "vwap", "bb_upper", "bb_lower", "momentum_3"
    ]))
...
def demonstrate_polars_aggregations():
    ...
    df_with_time = df.with_columns([
        (pl.col("timestamp") * 1000).cast(pl.Datetime(time_unit="ms")).alias("datetime"),
        pl.col("timestamp").map_elements(lambda x: int(x // 300) * 300, return_dtype=pl.Int64).alias("period_5m"),
    ])

    # Aggregate to 5-minute timeframe
    df_5m = df_with_time.group_by("period_5m").agg([
...
def demonstrate_polars_export_formats():
    ...
    # Create sample data
    data = [
        {"timestamp": 1672531200.0, "symbol": "BTCUSDT", "price": 16500.25, "volume": 125000.0},
        {"timestamp": 1672531260.0, "symbol": "BTCUSDT", "price": 16620.50, "volume": 135000.0},
        {"timestamp": 1672531320.0, "symbol": "ETHUSDT", "price": 1200.75, "volume": 85000.0},
        {"timestamp": 1672531380.0, "symbol": "ETHUSDT", "price": 1205.30, "volume": 92000.0},
    ]
