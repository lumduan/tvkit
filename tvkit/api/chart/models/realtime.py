...
class WebSocketConnection(BaseModel):
    uri: str = Field("wss://data.tradingview.com/socket.io/websocket?from=screener%2F", description="WebSocket URI to connect to")
    additional_headers: ExtraRequestHeader = Field(default=ExtraRequestHeader(), description="HTTP headers to include in the WebSocket handshake")
    compression: str = Field("deflate", description="WebSocket compression method by default is 'deflate'")
