            ...
            analysis_df: pl.DataFrame = (
                ...
                .with_columns(
                    [
                        ...
                        pl.col("close").rolling_mean(window_size=min(5, len(df))).alias("sma_5"),
                        pl.col("close").rolling_mean(window_size=min(10, len(df))).alias("sma_10"),
                        pl.col("volume")
                ...
                .with_columns(
                    [
                        ...
                        (pl.col("close") - pl.col("close").shift(min(3, len(df) - 1))).alias(
                            "momentum_3"
                        )
                        if len(df) > 3
