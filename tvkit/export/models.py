...
class ExportMetadata(BaseModel):
    ...
    interval: str | None = Field(default=None, description="Interval if applicable")
    record_count: int = Field(description="Number of records exported")
    format: ExportFormat = Field(description="Export format used")
    file_path: str | None = Field(default=None, description="Output file path")
...
class ExportResult(BaseModel):
    ...
    file_path: Path | None = Field(default=None, description="Output file path")
    error_message: str | None = Field(default=None, description="Error message if failed")
    data: Any | None = Field(default=None, description="Exported data (for in-memory formats)")
...
class OHLCVExportData(BaseModel):
    ...
    timestamp: float | str | datetime = Field(description="Timestamp")
    ...
    interval: str | None = Field(default=None, description="Time interval")
